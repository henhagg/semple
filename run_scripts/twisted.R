...
for (run_index in run_indices){
  ...
  inference = semple(observedData=observedData,burnin=burnin,K_start=K_start,cov_structure=cov_structure,maxiter=gllim_maxiter,prior_pdf=prior_pdf,sample_prior=sample_prior,
